          ...
          <tbody id="table-details">
            <tr id="row1" class="jdr1">
              ...
              <td><input class="form-control" name="jemail[]" placeholder="Email Address" type="email"></td>
				   ...
				   <div class="row">
                    <div class="col-md-4">
                        <button class="btn btn-primary btn-block btn-flat btn-add-more">Add More Employee</button>
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-primary btn-block btn-flat btn-remove-last">Remove Last Employee</button>
                    </div>
                    <div class="col-md-4">

...
<head>
  ...
  <title>List of Hired Employees | Manila South Cemetery</title>
                  ...
                  <?php  
                        ...
                        {  
                            ?><tr>  
                                ...
                                <td><?php echo $row->EMPLOYEE_DATECREATED;?></td> 
                                <td><?php echo $row->EMPLOYEE_LASTCHANGED;?></td>
                                <td><?php echo $row->EMPLOYEE_CHANGEDBY;?></td>

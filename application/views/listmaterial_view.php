...
<head>
  ...
  <title>List of Offers and Services | Manila South Cemetery</title>
    ...
    <div class = col-xs-12>
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">List of Offers and Services</h3>
        </div>
        <div class="box-body">
                  ...
                  <?php  
                        ...
                        {  
                            ?><tr>  
                                ...
                                <td><?php echo $row->MATERIAL_PERQUANTITY;?></td>
                                <td><?php echo $row->MATERIAL_DESCRIPTION;?></td>
                                <td><?php echo $row->MATERIAL_DATECREATED;?></td> 
                                <td><?php echo $row->MATERIAL_LASTCHANGED;?></td>
                                <td><?php echo $row->MATERIAL_CHANGEDBY;?></td>

...
<head>
  ...
  <title>List of Interred Deceased | Manila South Cemetery</title>
    ...
    <div class = col-xs-12>
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">List of Interred Deceased</h3>
        </div>
        <div class="box-body">
                   ...
                   <?php  
                        ...
                        {  
                            ?><tr>  
                                ...
                                <td><?php echo $row->DECEASED_BIRTHDATE;?></td>
                                <td><?php echo $row->DECEASED_DEATHDATE;?></td>
                                <td><?php echo $row->DECEASED_SEX;?></td>
                                <td><?php echo $row->DECEASED_DATECREATED;?></td> 
                                <td><?php echo $row->DECEASED_LASTCHANGED;?></td>
                                <td><?php echo $row->DECEASED_CHANGEDBY;?></td>

...
<body>
        <h5><?php echo $EMPLOYEE_FNAME;?></h5>
        <h5><?php echo $EMPLOYEE_MNAME;?></h5>
        <h5><?php echo $EMPLOYEE_LNAME;?></h5>
        ...
        <h5><?php echo $EMPLOYEE_CHANGEDBY;?></h5>
        <h5><?php echo $EMPLOYEE_STATUS;?></h5>
</body>
</html>